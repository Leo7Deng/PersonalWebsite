...
const _initialCubeData = [
    { size: 40, rotate: -25, x: 270, y: -140 },
    { size: 30, rotate: 30, x: -250, y: 200 },
    { size: 45, rotate: 40, x: -360, y: -90 },
    { size: 50, rotate: -65, x: 250, y: 100 },
    { size: 26, rotate: 75, x: 170, y: 160 },
    { size: 30, rotate: -10, x: -190, y: -200 },
]
// const _initialCubeData = [
